...
import com.rimi.gpangel.angeldoctor.AngelApplication;
import com.rimi.gpangel.angeldoctor.BaseActivity;
import com.rimi.gpangel.angeldoctor.R;
import com.rimi.gpangel.angeldoctor.adapter.MainListAdapter;
import com.rimi.gpangel.angeldoctor.bean.Report;
import com.rimi.gpangel.angeldoctor.bean.TodayAppointment;
...
import com.rimi.gpangel.angeldoctor.widget.CircleImageView;
import com.rimi.gpangel.angeldoctor.widget.RefreshLayout;
...
//        params.addBodyParameter("doctor_name",getDocName());
    ...
    public void loadTodayAppointment(String date){
        RequestParams params = new RequestParams(HttpUrls.TEST_URL + "Customer/MyAppointentInfo.ashx?action=Dea");
