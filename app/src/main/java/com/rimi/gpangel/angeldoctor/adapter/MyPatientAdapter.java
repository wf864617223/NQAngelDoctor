package com.rimi.gpangel.angeldoctor.adapter;
...
import com.rimi.gpangel.angeldoctor.activity.MyPatientActivity;
import com.rimi.gpangel.angeldoctor.activity.PatientDataActivity;
import com.rimi.gpangel.angeldoctor.activity.UserinfoActivity;
...
public class MyPatientAdapter extends BaseAdapter{
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        holder.cardTypeTv.setText(list.get(position).getIC_TYPE());
