...
import com.rimi.gpangel.angeldoctor.adapter.MyViewPagerAdapter;
import com.rimi.gpangel.angeldoctor.adapter.ReportCommonAdapter;
import com.rimi.gpangel.angeldoctor.bean.PatientData;
import com.rimi.gpangel.angeldoctor.bean.ReportDate;
import com.rimi.gpangel.angeldoctor.fragment.RecordFragment;
import com.rimi.gpangel.angeldoctor.fragment.ReportListFragment;
import com.rimi.gpangel.angeldoctor.http.HttpUrls;
import com.rimi.gpangel.angeldoctor.http.MyCallBack;
import com.rimi.gpangel.angeldoctor.http.PhoneCallBack;
import com.rimi.gpangel.angeldoctor.http.XHttpRequest;
import com.rimi.gpangel.angeldoctor.utils.Base64Utils;
import com.rimi.gpangel.angeldoctor.utils.CommonUtils;
import com.rimi.gpangel.angeldoctor.utils.GsonUtils;
import com.rimi.gpangel.angeldoctor.utils.HttpLoadImg;
import com.rimi.gpangel.angeldoctor.utils.SPUtils;
...
//                ageTv.setText(getResources().getString(R.string.age) + age);
    ...
    private void loadCommonData(final String id, final String type, String patName){
        CommonUtils.getLoading(this, "加载中.....");
        RequestParams params = new RequestParams(HttpUrls.REPORT);
        params.addBodyParameter("method", "info");
        params.addBodyParameter("type",type);
        params.addBodyParameter("id",id);
        params.addBodyParameter("PatName",patName.trim());
...
//                        ageTv.setText(getResources().getString(R.string.age) + result.getString("Age"));
                        sexTv.setText(getResources().getString(R.string.sex) + (result.getString("Sex")));
