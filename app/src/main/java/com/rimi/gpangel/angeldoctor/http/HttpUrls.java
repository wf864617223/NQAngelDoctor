package com.rimi.gpangel.angeldoctor.http;
...
//    public static final String TEST_URL = "http://61.139.124.246:90/";
    //南区angel医院接口
    public static final String TEST_URL = "http://125.69.90.148:25322/";
    //rimi 测试接口 内网
...
//    private static final String RIMI_TEST_URL = "http://app.cdangel.com/"; //外网
    ...
    public static final String RIMI_TEST_URL = "http://angelapp.cdangel.com/"; //外网
    ...
    //检查更新
    public static final String CHECK_VERSION = RIMI_TEST_URL + "checkversioncode.json";
    //获取客服电话
